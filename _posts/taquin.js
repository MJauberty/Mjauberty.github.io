...
// Couleurs si l'image ne peux pas ̻tre charg̩e
var colors = [
...
function help() {
    show_help = !show_help;
    if(show_help) {
        document.getElementById('help').innerHTML = 'Je me d̩brouille comme un.e grand.e &#128526;';
...
function help_2() {
    alert("Il faut remettre l'image dans le bon ordre en d̩pla̤ant les cases.\nLa m̩thode g̩n̩rale est : remettre les cases dans l'ordre ligne par ligne pour les deux premi̬res lignes, puis colonnes par colonnes pour les deux dernieres, tout cela dans l'ordre de lecture.\nSi vous n'y arrivez toujours pas, cherchez sur internet la flemme d'expliquer plus.");
}
